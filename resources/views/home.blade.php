...
<div class="flex flex-col gap-4">
    <div
        class="relative w-11/12 mx-auto rounded-2xl overflow-hidden bg-cover bg-no-repeat bg-[url('https://images.squarespace-cdn.com/content/v1/5aadf482aa49a1d810879b88/1626698419120-J7CH9BPMB2YI728SLFPN/1.jpg')]">
        ...
        <div class="relative z-10 flex flex-col gap-6 pt-[130px] text-white">
            ...
            <div class="w-10/12 mx-auto flex bg-white shadow border border-gray-400 rounded-lg text-xl text-black">
                <div class="w-3/12 p-3 flex flex-col gap-2 bg-pink-300">
                ...
                <div class="w-8/12 p-2 flex flex-col gap-2">
                    <div class="flex gap-2 items-center">
                ...
                <button type="submit" class="w-1/12 p-2 bg-pink-500 text-white rounded hover:bg-pink-600">Tìm
                    kiếm</button>
            </div>
