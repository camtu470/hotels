    ...
    <div class="w-2/12 border flex flex-col gap-4 p-4 rounded-lg">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
                @for ($i = 1; $i <= 5; $i++) <label class="flex items-center gap-2">
                    <input type="checkbox" name="star_rating[]" value="{{ $i }}" class="form-checkbox text-pink-600">
                    {{ $i }} sao
                    </label>
                    @endfor
            </div>
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
                ...
                <label class="flex items-center gap-2">
                    <input type="checkbox" name="bed_types[]" value="{{ $type }}" class="form-checkbox text-pink-600">
                    {{ $type }}
                </label>
                @endforeach
            </div>
                ...
                <div class="w-5/12 flex flex-col gap-2 px-2 border-r">
                    <div class="flex flex-col gap-2 border-b p-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-sm">28, Thi Sach Street, The Song, The Sóng, Thắng Tam, Vũng Tàu, Việt Nam
                            </p>
                        </div>
                    </div>
